(function () {
    ...
    indicator.className =
        "fixed bottom-4 right-4 z-50 bg-black/40 backdrop-blur-md opacity-50 hover:opacity-100 transition-opacity duration-300 text-white px-3 py-1.5 rounded-full text-xs font-mono shadow-lg border border-white/10 flex items-center gap-2";
